import { InputHandler } from "./class/inputHandler.mjs";
import { LevelManager } from "./class/level.mjs";
import { Player } from "./class/player.mjs";
import { CreateLevel_1 } from "./levels/level_1.mjs";
...
function gameLoop() {
    ...
    currentLevel.player.move(input);
